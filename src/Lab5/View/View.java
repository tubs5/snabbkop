...
public class View extends SimView {
	...
	public void update(Observable arg0, Object arg1) {
		...
		if (!(arg1 instanceof CloseEvent)) {
			System.out.println(state.getTime() + " " + action + " " +id + open+ "" + state.getActiveKassor()+ " " +totalledig + " " + state.getCurrentCustomers() + " " + state.getCompletedCustomers()+" "+ state.getMissedCustomers()+" " + stime);
		}
